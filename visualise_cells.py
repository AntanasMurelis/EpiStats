...
#     output_directory = '/Users/antanas/BC_Project/Control_Segmentation_final/BC_control_s_5_e_1_d_5'
#     processed_labels_path = os.path.join(output_directory, 'processed_labels.npy')
#     processed_labels = np.load(processed_labels_path)
    
#     overlay_meshes_and_labels(processed_labels_path, output_directory, cell_id = None, filtered = True)
