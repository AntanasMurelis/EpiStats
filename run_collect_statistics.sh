...
python $python_script $labeled_img $img_resolution $contact_cutoff $clear_meshes_folder $smoothing_iterations $erosion_iterations $dilation_iterations $output_folder $meshes_only $overwrite $preprocess
