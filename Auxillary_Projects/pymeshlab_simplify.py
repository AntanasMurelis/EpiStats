...
def remesh(input_dir, min_edge_length=0.1):
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith('.stl') or filename.endswith('.ply'):
            ...
            # ms.apply_filter('generate_surface_reconstruction_vcg', normalsmooth=3, smoothnum = 0, simplification = True)
            ...
            ms.apply_filter('apply_coord_laplacian_smoothing_surface_preserving', iterations=20)
