...
if __name__ == '__main__':
    ...
    output_directory = '/Users/antanas/BC_Project/Control_Segmentation/Maoxia_15_s_4_e_2_d_3'
    processed_labels_path = os.path.join(output_directory, 'processed_labels.npy')
    processed_labels = np.load(processed_labels_path)
    
    overlay_meshes_and_labels(processed_labels_path, output_directory, cell_id = None, filtered = False)
