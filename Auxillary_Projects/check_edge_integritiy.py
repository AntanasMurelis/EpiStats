...
def clean_meshes_in_directory(directory):
    for filename in os.listdir(directory):
        if filename.endswith(".ply") or filename.endswith(".stl"):
            ...
            cleaned_mesh_path = os.path.join(directory, cleaned_filename)
...
if __name__ == '__main__':
    ...
    # ###### Visualise cube using napari ######################
    # viewer = napari.Viewer()
    # viewer.add_surface([cube.vertices, cube.faces], name='broken cube')
    # napari.run()
    # #########################################################
    ...
    # viewer = napari.Viewer()
    # viewer.add_surface([cube.vertices, cube.faces], name='fixed cube')
    # napari.run()
    # #########################################################
    ...
    directory = '/Users/antanas/BC_Project/For_Steve_Cleaned_Remeshed_No_smoothing'
    clean_meshes_in_directory(directory)
    # cube = trimesh.load('/Users/antanas/BC_Project/For_Steve/cell_93.stl')
